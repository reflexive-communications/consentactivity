 ...
 */
class CRM_Consentactivity_Upgrader_Base {

  /**
   * @var CRM_Consentactivity_Upgrader_Base
   */
  ...
  public static function instance() {
    if (!self::$instance) {
      self::$instance = new CRM_Consentactivity_Upgrader(
        'consentactivity',
        E::path()
      );
    }
   ...
   *
   * ```
   * CRM_Consentactivity_Upgrader_Base::_queueAdapter($ctx, 'methodName', 'arg1', 'arg2');
   * ```
   */
  ...
  /**
   * CRM_Consentactivity_Upgrader_Base constructor.
   *
   * @param $extensionName
   * @param $extensionDir
   */
